...
#get the list of inputs and their targets
inputs=data_format.INPUT.values
...
# Tokenize all of the inputs and map the tokens to thier word IDs.
input_ids = []
...
for elmt in inputs:
    ...
    encoded_inp = tokenizer.encode(
                        elmt,                      # Sentence to encode.
...
input_ids = pad_sequences(input_ids, maxlen=MAX_LEN, dtype="long", value=0, truncating="pre", padding="post")
...
train_masks, validation_masks, _, _ = train_test_split(attention_masks, targets, random_state=2018, test_size=0.1)
...
# the 'W' may stand for 'Weight Decay fix"
