...
def load_data(rank,batch_size):
    ...
    test_sampler = SequentialSampler(test_data) # we don't use the DistributedSampler here because the test is on a CPU
...
def main(rank: int, world_size: int, save_every: int, total_epochs: int, batch_size: int):
    ...
    model_to_save.save_pretrained('/home/daril_kw/data/model_parallel_gene')
