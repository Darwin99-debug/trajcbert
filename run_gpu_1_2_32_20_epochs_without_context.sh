...
#SBATCH --gres=gpu:4
#SBATCH --time=4-0:00
#SBATCH --job-name=trajcbert_on_gpu_1_2_batch_size_32_4_DAYS_20_epochs_without_context
...
python parallelisation_gpu_train_1_2_bs_32_20_epochs_without_context.py
