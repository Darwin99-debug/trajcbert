...
#SBATCH --gres=gpu:1
#SBATCH --time=4-0:00
#SBATCH --job-name=trajcbert_test_1_point_1_2_data_with_context_bs_32_100_epochs
...
PRETRAINED_MODEL_NAME="/home/daril/scratch/data/trajcbert/models/model_saved_parallel_version_1_2_bs_32_100_epochs"
