...
class Trainer:
    ...
    def _save_checkpoint(self, epoch):
        ...
        PATH = f"/home/daril/scratch/data/trajcbert/models/model_saved_parallel_version_full_bs_32_100_epochs_with_context/checkpoints/checkpoint_epoch_{epoch}.pt"
        torch.save(ckp, PATH)
...
def main(rank: int, world_size: int, save_every: int, total_epochs: int, batch_size: int):
    ...
    model_to_save.save_pretrained('/home/daril/scratch/data/trajcbert/models/model_saved_parallel_version_full_bs_32_100_epochs_with_context')
