...
DIR_INPUTS_IDS = '/home/daril/scratch/data/trajcbert/savings_for_parallel_with_dest_context_1_2/input_ids_full_opti_for_para_833383_without_context.pkl'
DIR_ATTENTION_MASKS = '/home/daril/scratch/data/trajcbert/savings_for_parallel_with_dest_context_1_2/attention_masks_full_opti_for_para_833383_without_context.pkl'
DIR_TARGETS = '/home/daril/scratch/data/trajcbert/savings_for_parallel_with_dest_context_1_2/targets_full_opti_for_para_833383_without_context.pkl'
...
class Trainer:
    ...
    def _save_checkpoint(self, epoch):
        ...
        PATH = f"/home/daril/scratch/data/trajcbert/models/model_saved_parallel_version_1_2_bs_32_100_epochs_without_context/checkpoints/checkpoint_epoch_{epoch}.pt"
        torch.save(ckp, PATH)
...
def main(rank: int, world_size: int, save_every: int, total_epochs: int, batch_size: int):
    ...
    model_to_save.save_pretrained('/home/daril/scratch/data/trajcbert/models/model_saved_parallel_version_1_2_bs_32_100_epochs_without_context')
...
if __name__ == "__main__":
    ...
    with open("config_1_2_batch_size_32_100_epochs.json") as json_file:
